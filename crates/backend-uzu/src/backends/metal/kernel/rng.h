...
inline void curand_philox4x32_10(thread uint* ctr, thread uint* key, thread uint* out) {
  ...
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 2
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 3
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 4
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 5
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 6
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 7
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 8
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 9
  philox4x32bumpkey(local_key);
  philox4x32round(local_ctr, local_key); // 10
