...
def convert(
    ...
    quantize_embeddings: Annotated[
        ...
        Option(
            help=(
                "Quantize the tied embedding table to this bit width (4 or 8). "
                "The table doubles as the vocab readout, so on bf16 exports this "
                "cuts 20-32% of per-token weight traffic at ~2e-3 max abs error."
            ),
    ...
    embedding_group_size: Annotated[
        int,
        Option(
